...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Process only the first N train days",
    )
    return parser.parse_args()


def run(limit_days: int | None = None) -> None:
    cfg = BaselineConfig()
    ...
    output_path = cfg.output_dir / "baseline_metrics.csv"
...
if __name__ == "__main__":
    args = parse_args()
    run(limit_days=args.limit_days)
